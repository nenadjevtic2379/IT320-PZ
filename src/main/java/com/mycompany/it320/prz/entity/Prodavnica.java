...
public class Prodavnica implements Serializable {
    ...
    private User idUser;
    @Column(name = "DATUMMODIFIKACIJE")
    @Temporal(TemporalType.TIMESTAMP)
    @ApiModelProperty(notes = "modification date")
    private Date datummodifikacije;
    @Column(name = "STATUS")
  ...
  /*  @OneToMany(mappedBy = "idProdavnica")
    ...
    public Date getDatummodifikacije() {
        return datummodifikacije;
    }

    public void setDatummodifikacije(Date datummodifikacije) {
